...
# the Julia API also defines a ``snake case'' alias, i.e. `add_point'. You can
...
#
# See the extended tutorial `x1.jl' for a fuller description of this entity,
...
#
# See e.g. `t16.jl', `t18.jl', `t19.jl' or `t20.jl' for complete examples based
