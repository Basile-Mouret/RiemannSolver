...
"""
function get_hll_flux_3D(U_l::AbstractVector{T}, U_r::AbstractVector{T}, gamma::T) where {T<:Real}
...
"""
function get_hll_flux_1D(U_l::AbstractVector{T}, U_r::AbstractVector{T}, gamma::T) where {T<:Real}
...
"""
function get_hll_flux_2D(U_l::AbstractVector{T}, U_r::AbstractVector{T}, gamma::T) where {T<:Real}
